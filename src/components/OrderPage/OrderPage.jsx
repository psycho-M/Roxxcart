    ...
    return(
        ...
        <div className="container">
           ...
           <div className="cart-items">
            ...
            <div className="total">
                <p>Total Cost: <span style={{fontFamily:"sans-serif", marginLeft:"2rem", fontWeight:"bolder"}}>₹2998</span></p>
            </div>
           </div>
        </div>
        <div className="end">
